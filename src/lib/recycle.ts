...
export const LoginRequest = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): LoginRequest {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: message.email = reader.string(); break;
        case 2: message.password = reader.string(); break;
...
export const LoginResponse = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): LoginResponse {
    ...
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: message.token = reader.string(); break;
        case 2: message.userId = reader.string(); break;
        case 3: message.error = reader.string(); break;
        default: reader.skipType(tag & 7); break;
      }
    }
    return message;
...
export const ProfileRequest = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ProfileRequest {
    ...
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: message.userId = reader.string(); break;
        default: reader.skipType(tag & 7); break;
      }
    }
    return message;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ProfileResponse {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: message.fullName = reader.string(); break;
        case 3: message.role = reader.string(); break;
        default: reader.skipType(tag & 7); break;
      }
    }
    return message;
...
export const TransactionRequest = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): TransactionRequest {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: message.userId = reader.string(); break;
        case 2: message.wasteTypeId = reader.string(); break;
...
export const TransactionResponse = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): TransactionResponse {
    ...
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: message.status = reader.string(); break;
        case 2: message.message = reader.string(); break;
        case 3: message.totalPrice = reader.float(); break;
        default: reader.skipType(tag & 7); break;
      }
    }
    return message;
...
export const WasteType = {
  ...
  // SAYA TAMBAHKAN DECODE AGAR FRONTEND BISA BACA DAFTAR SAMPAH
  decode(input: _m0.Reader | Uint8Array, length?: number): WasteType {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseWasteType();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: message.id = reader.string(); break;
        case 2: message.name = reader.string(); break;
        case 3: message.pricePerKg = reader.float(); break;
        default: reader.skipType(tag & 7); break;
      }
    }
    return message;
...
export const WasteTypeList = {
  ...
  // SAYA TAMBAHKAN DECODE JUGA DI SINI
  decode(input: _m0.Reader | Uint8Array, length?: number): WasteTypeList {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseWasteTypeList();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: message.items.push(WasteType.decode(reader, reader.uint32())); break;
        default: reader.skipType(tag & 7); break;
      }
    }
    return message;
