    ...
    try {
      ...
      if (addNotificationCallback) {
        addNotificationCallback(
          "Pengaduan Terkirim",
          "Pengaduan Anda sedang diproses oleh RT/RW.",
          "info",
        );
      }
              ...
              <div className="flex justify-between items-start mb-3">
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Kategori: <span className="font-medium">{c.category}</span>{" "}
      ...
      <div className="bg-white rounded-xl p-6 w-full max-w-lg shadow-2xl animate-in zoom-in duration-200">
        <div className="flex justify-between items-center mb-6 border-b pb-4">
          <h3 className="font-bold text-xl text-gray-800 flex items-center gap-2">
            <MessageCircle size={22} className="text-green-600" /> Buat
            Pengaduan Baru
          </h3>
          <button
            onClick={onClose}
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">
              {formData.subject.length}/150 karakter
            </p>
          </div>
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-gray-800 font-medium bg-gray-50 px-3 py-2 rounded border border-gray-200">
                {complaint.category}
              </p>
            </div>
            <div>
