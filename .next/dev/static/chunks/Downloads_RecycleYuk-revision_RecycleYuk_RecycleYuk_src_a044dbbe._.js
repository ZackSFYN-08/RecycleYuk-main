...
function UserDashboard() {
    ...
    // --- 1. STATE MANAGEMENT (Maps setup removed, now using OpenLayersMap) ---
    ...
    // Geolocation State
    const [userLocation, setUserLocation] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$RecycleYuk$2d$revision$2f$RecycleYuk$2f$RecycleYuk$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
        ...
        "UserDashboard.useEffect": ()=>{
            if (mounted && navigator.geolocation) {
                navigator.geolocation.getCurrentPosition({
                    "UserDashboard.useEffect": (position)=>{
                        setUserLocation({
    ...
    const processPayment = async ()=>{
        ...
        try {
            ...
            console.error("Payment Error:", error_2);
    ...
    // Memoize tracking markers to prevent map refresh
    const trackingMarkers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$RecycleYuk$2d$revision$2f$RecycleYuk$2f$RecycleYuk$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "UserDashboard.useMemo[trackingMarkers]": ()=>{
            if (!userLocation || !activePickup) return [];
            return [
                {
                    ...
                    popup: `
                    <div class="p-2">
                        <strong class="text-blue-600">Lokasi Anda</strong><br/>
                        <span class="text-xs text-gray-600">Menunggu driver</span>
                    </div>
                `
                },
                {
                    lat: activePickup.driver_latitude || userLocation.lat + 0.005,
                    lng: activePickup.driver_longitude || userLocation.lng + 0.005,
                    label: '🚛',
                    popup: `
                    <div class="p-2">
                        <strong class="text-green-600">${activePickup.driver}</strong><br/>
                        <span class="text-xs text-gray-600">Sedang menuju lokasi Anda</span>
                    </div>
                `
                }
            ];
...
_s(UserDashboard, "Q0MDQDrtWGbgHgW32TVWPgD8U4o=", false, function() {
    return [
...
//# sourceMappingURL=Downloads_RecycleYuk-revision_RecycleYuk_RecycleYuk_src_a044dbbe._.js.map